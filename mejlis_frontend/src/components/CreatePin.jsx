                ...
                <label>
                  <div className='flex flex-col items-center justify-center h-full'>
                      ...
                      <p className='mt-32 text-gray-400'>
                       use high-quality JPG, SVG, PNG, GIF or TOFF less than 20 MB
                      </p>
                  </div>
                  <input 
                  type='file'
              ...
              <div>
                <p className='mb-2 font-semibold text-lg sm:text-xl'>Choose pin category </p>
                  <select name="" id=""
                     ...
                     className='outline-none w-4/5 text-ase border-b-2 border-gray-200 p-2 rounded-md cursor-pointer'
                  >
